...
import { useAdminUsers, useForceDeleteUser } from "@/lib/api/admin";
import {
  Table,
  TableHeader,
  TableBody,
...
export function AdminUsersPanel() {
  ...
  const deleteUser = useForceDeleteUser();
      ...
      <Dialog open={!!confirmDelete} onOpenChange={() => setConfirmDelete(null)}>
        <DialogContent>
          ...
          <p className="text-sm text-muted-foreground">
            ...
            will also remove all their event memberships. This action cannot be undone.
          </p>
          <DialogFooter>
