...
export function PhotoGallery({ eventId, photoLimit, canUpload = true }: Props) {
  const t = useTranslations("attendeeApp.photos");
            ...
            <>
              ...
              {uploading ? (
                <div className="flex items-center gap-3 rounded-xl border-2 border-dashed border-blue-200 p-4 text-blue-600">
                  ...
                  <span className="text-sm">{uploadProgress || t("uploading")}</span>
                </div>
              ) : remaining > 0 ? (
                <div className="flex gap-3">
                  ...
                  >
                    ...
                    <p className="text-xs font-medium text-gray-700">{t("takePhoto")}</p>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <p className="text-xs font-medium text-gray-700">{t("upload")}</p>
                  </button>
                </div>
              ) : (
